...
- **Chart everything.** Sailing into a new cell inks it into your map
  ...
  **Isle cells roll no random encounters** — but their guardians will find you.
- **Spot ports from the sea**: beaches with plank-dock tiles are dockable.
  Every port you dock at is inked onto your chart as a little house.
...
- **Broadside.** A fires your cannons — at the enemy if one is engaged,
  ahead otherwise. Pirates take 3 hits, isle guardians 5, and guardians fire
  half again as fast. A sunk ship spills gold. Close the distance or run —
  enemies give up the chase beyond about 15 tiles.
